const Mustang1 = {
    Generation: "Primera generación (1964 ½-1973)",
    Year: 1965,
    Img1: "img/1964.jpg",
    Img2: "img/1965.jpg",
    sound: "audio/1965.ogg",
    ...
    Se ofrece por primera vez el motor V8 "Windsor" que produce 250 HP (253 CV; 186 kW) de potencia con carburador de dos bocas, o de 290 HP (294 CV; 216 kW) de potencia con carburador de cuatro bocas. El Boss 351 era un motor que desarrollaba 330 HP (335 CV; 246 kW), mientras que los de 429 plg (7 litros) llegaban a 370 HP (375 CV; 276 kW). dotado con un V8 Cleveland y 350 HP (355 CV; 261 kW), fue el que ocupó su lugar, sin llegar a desarrollar los más de 300 HP (304 CV; 224 kW) que desarrollaba el Boss, pero ofrecía el mismo estilo coupé y magnífico desempeño.`,
  ...
  const Mustang2 = {
    Generation: "Segunda generación (1973-1978)",
    Year: 1975,
    Img1: "img/2 gen.jpg",
    Img2: "img/1975.jpg",
    sound: "audio/1973.ogg",
  ...
  const Mustang3 = {
    Generation: "Tercera generación (1978-1993)",
    Year: 1983,
    Img1: "img/1983.jpg",
    Img2: "img/1990.jpg",
    sound: "audio/1990.ogg",
    history: `El Mustang III sería uno de los muchos modelos que habían planeado desarrollar sobre la nueva plataforma y se presentó varios meses después del debut de la línea Fairmont / Zephyr, para que coincidiera con el inicio del año modelo 1979 y no se tomó a la ligera la presentación de la nueva generación III, ya que es uno de los autos más impactantes en la historia contemporánea de la industria automotriz
    El llamado “New Breed” era más corto que el Fairmont, lo cual le daba exclusividad y mejoraba su desempeño, haciéndole más ágil, que le permitía también cautivar a antiguos dueños de Mustang II o restar ventas a otros “deportivos” como los Celica, los Monza, los Scirocco, etc. Los principios básicos de diseño del motor de cuatro cilindros con levas en lo alto, llevado a 140 plg (2,3 litros) y a la tornillería de base métrica, se conservaron en el “New Breed”. El año de 1981 fue de aciago para la industria y Ford ofreció un V8 reducido a 255 plg (4,2 litros) y algo más de 100 HP (101 CV; 75 kW), lo cual pareció una buena respuesta en términos de economía, considerando que permitía seguir usando un V8 en esos días en los que automovilistas e industria migraban a motores de cuatro cilindros, pero no fue convincente por su rendimiento y Ford dejó de ofrecerlo. Se cuestionaba a la industria norteamericana por lo anticuado de sus motores y clamaban por motores más "europeos” con bajos desplazamientos, altas compresiones, turbos y complejos sistemas de gestión, así que acabaron aclamando que en 1982 se relanzara la versión GT para relevar al Mustang Cobra Turbo, ya que el nuevo GT tenía un V8 de 302 plg (4,9 litros) configurado para ofrecer máximo rendimiento, pero midiendo su capacidad en litros, por lo que fue rebautizado "5.0 HO" (por High Output).`,
  ...
  const Mustang5 = {
    Generation: "Quinta generación (2004-2014)",
    Year: 2005,
    Img1: "img/2005.jpg",
    Img2: "img/2012.jpg",
    sound: "audio/2005.ogg",
